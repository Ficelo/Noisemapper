...
while ($row = $result->fetch_assoc()) {
    ...
    // Affichage de la photo de profil de l'utilisateur avec son prénom
    if ($row['user_photo'] !== null) {
        echo "<img src='{$row['user_photo']}' alt='Photo de profil de {$row['user_prenom']} {$row['user_nom']}' width='50' height='50'class='profile-picture'>";
    }
